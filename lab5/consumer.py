...
class Consumer(object):
    ...
    """
    EXCHANGE = os.getenv('WORKER_EXCHANGE')
    EXCHANGE_TYPE = ExchangeType.topic
    QUEUE = os.getenv('WORKER_QUEUE_NAME')
    ROUTING_KEY = os.getenv('WORKER_ROUTING_KEY')
...
def main():
    ...
    amqp_url = os.getenv('WORKER_AMQP_URL', 'localhost')
