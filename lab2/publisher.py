...
# based on https://github.com/pika/pika/blob/master/examples/asynchronous_publisher_example.py
...
class ExamplePublisher(object):
    ...
    def publish_message(self):
        ...
        hdrs = {u'one': u' two', u'three': u'four', u'five': u'six'}
        properties = pika.BasicProperties(
            app_id='example-publisher',
            content_type='application/json',
            headers=hdrs)

        message = str(datetime.datetime.now()) + str(uuid.uuid4())
